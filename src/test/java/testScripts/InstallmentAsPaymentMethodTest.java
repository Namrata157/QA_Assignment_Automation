...
public class InstallmentAsPaymentMethodTest extends BaseClass{
	@Test
	public void InstallmentAsPaymentMethodTest() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		cg.selectInstallmentPaymentOption(driver);
		
		FinalPaymentMethodPage fg=new FinalPaymentMethodPage(driver);
		System.out.println("Final Payment Status----------"+fg.getInstallmentStatusHeader()+"-----------");
	}
