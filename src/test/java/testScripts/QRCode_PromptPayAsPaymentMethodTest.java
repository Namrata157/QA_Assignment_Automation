...
public class QRCode_PromptPayAsPaymentMethodTest extends BaseClass {
	
	@Test
	public void QRCode_PromptPayAsPaymentMethodTest() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		cg.selectQRCodePaymentOption();
		
		FinalPaymentMethodPage fg=new FinalPaymentMethodPage(driver);
		System.out.println("Final Payment Status---------"+fg.getScanQRCodeheader()+"---------");
	}
